...
% Load a topo file
inFile = 'landscapes/GenericRidgeRot90.mat';
...
bts_inty = (rock_uplift*1.8e6) ./ (bts_dzdy * (y/dy))-55;    % surface y-intercept of upper caprock top edge (m)
...
backtiltstrat2lyr = [backtiltstrat2lyr1; backtiltstrat2lyr2];
